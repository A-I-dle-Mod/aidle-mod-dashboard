      ...
      {user === null ? null : (
        <>
          <header className='mb-8'>
            <h1 className='text-2xl font-semibold text-zinc-900 dark:text-zinc-100'>Dashboard Home</h1>
            <p className='mt-1 text-zinc-600 dark:text-zinc-400'>Welcome, {user.global_name}!</p>
          </header>
          <div>
            <header>
              <h2 className='text-xl font-semibold text-zinc-900 dark:text-zinc-100'>Overview</h2>
            </header>
                  ...
                  servers.guilds.map((server: Server) => (
                    <div key={server.id}>
                      ...
                      <div className='mt-6 text-lg/6 font-medium sm:text-sm/6 inline-grid w-full grid-cols-[auto_1fr]'>
                        ...
                        <span className='m-1 ms-2'>{server.guild_name}</span>
                      </div>
